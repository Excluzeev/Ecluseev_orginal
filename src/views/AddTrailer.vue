          ...
          <p>
            ...
            &nbsp;<i class="fa fa-angle-right"></i>
                ...
                <router-link
                      ...
                      >
                      {{channelData.title}}
                    </router-link>&nbsp;<i class="fa fa-angle-right"></i><a href="#">Upload a video</a>
          </p>
       </div>
      </div>
              ...
              <div class="file_upload_top_section">
                <div class="form-group fileUpload-input vedioUpload-input">
                  ...
                  <div class="upload-btn-wrapper">
                    ...
                    style="width:100%;height:100px;text-transform:initial;padding:0"
              ...
              <div class="form-group ">
                <div class="image-holder" v-if="hasCustomThumbnail">
                  ...
                  <upload-btn
                    ...
                    style="background-color: #fff !important;width:100%;height:100px;padding:0;border-radius:15px"
                    class="white--text"
            ...
            <div class="create_form_section">
              <div class="form-row">
                <div class="form-group" style="width:100%">
                  ...
                  <textarea v-model="description" class="form-control" id="longDescription" placeholder="Please type long description" rows="6" style="width:100%"></textarea>
...
<style scoped>
  ...
  .v-btn.upload-btn-hover.v-btn--round.primary.upload-btn,
  #upload_videos_previews_page .upload-btn label{
    width: 100%;
    padding: 0;
    margin: 0;
    height: 200px;
...
#upload_videos_previews_page .row,
  #upload_videos_previews_page .container-fluid{padding:0}
}
</style>
