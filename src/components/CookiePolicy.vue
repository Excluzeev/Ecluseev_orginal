<template>
  <v-container>
    ...
    <p>
      Before Cookies are placed on your computer or device, you will get a
      prompt requesting your consent to set those Cookies. By giving your
      ...
      to the placing of Cookies (unless those Cookies are from the Essential
      category); however certain features of our site may not function fully or
